...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 21 Des 2019 pada 10.55
...
(5, 'Crew Media Informatc', '2019-12-19 10:33:36', 1, 'Administrator', 5, 'c4e892b6ce16b5b0480d7fa3036c5bdc.png');
...
(20, 'Rahmandani', '2019-12-19 10:36:44', '045f4d0178fd9e248eaf878cf2781643.JPG', 5, 1, 'Administrator'),
(21, 'Defta Pradana ', '2019-12-19 11:02:11', '4cfc55d002bdf2fef3b23cb505efa9d0.jpeg', 5, 1, 'Administrator'),
(22, 'Ananda Adhe', '2019-12-19 11:02:37', 'a6017eb3ea030ab3f0ae1bf57d037cca.jpeg', 5, 1, 'Administrator'),
(23, 'Winda Ramadhanty', '2019-12-19 11:08:47', 'fa20b6d2727098966c8933b17bd83407.png', 5, 1, 'Administrator'),
(24, 'M Syaifurriza', '2019-12-19 11:24:56', 'd26db1b5e797f298495f896f674726b7.jpeg', 5, 1, 'Administrator');
...
(946, '2019-11-05 09:50:11', '::1', 'Firefox'),
(947, '2019-12-19 07:48:02', '::1', 'Firefox');
...
(8, 'Rifani : IPK Terbaik Dimulai dari Sugesti', '<p>Dikutip dari laman http://jtif.ft.unesa.ac.id</p>\r\n\r\n<p>Dari ratusan mahasiswa Jurusan Teknik Informatika UNESA, Rifani Puji Rahmawati prodi D3 MI 2013 C pada Yudisium III 2016 berhasil meraih Indeks Prestasi Kumulatif (IPK) terbaik yakni 3.70 . Ini merupakan kali kedua Rifani mendapatkan predikat IPK terbaik. Meskipun ada kegiatan selain kuliah seperti mengajar les privat, Rifani tidak merasa kesulitan dalam mengatur waktunya untuk kuliah dan mengajar les privat. Kuncinya yaitu selalu menyempatkan waktu untuk belajar setiap harinya. Rifani yang selama 6 semester ini grafik IPnya selalu naik mengaku bahwa dirinya sama sekali tidak mau berfikir negatif terhadap dosennya, meskipun terkadang memang ada kriteria dosen yang kurang sesuai dengan dirinya. Rifani mengatakan bahwa dosen memang mempunyai karakteristik masing-masing. Kita sebagai mahasiswa tidak boleh berpikir negatif atas sifat dosen. Semua itu juga untuk kita agar lebih displin. Karena kita sudah mahasiswa, bukan lagi siswa SMA. Kalau pikiran kita sudah negatif terhadap dosen yang mengajar, dampaknya akan kembali kepada diri sendiri. Seperti jadi malas mengikuti mata kuliah dosen tersebut, mengerjakan tugas jadi sering mencontek, tidak serius mengikuti mata kuliah tersebut dan akhirnya dampak negatif yang didapat yakni mendapat nilai jelek. (Novita) Berikut tips meraih IPK terbaik menurut Rifani Puji Rahmawati : 1. Lakukan yang terbaik. 2. Jangan men-judge dosen dengan hal yang negatif. 3. Berfikir positif terhadap dosen. 4. Sugesti diri sendiri dengan hal yang positif. 5. Usahakan mengerjakan tugas tidak mendadak. 6. Sempatkan waktu untuk belajar setiap harinya.</p>\r\n', '2019-12-19 10:30:38', 'Administrator', '643918cc07e5a64c0406dba54b6d6bc0.jpeg');
...
(32, 'Resmikan Gedung Megah Teknik Informatika Unesa, Emil: Insya Allah Jadi Fakultas', '<p>Dikutip dari laman berita : beritajatim.com</p>\r\n\r\n<p><strong>Surabaya (beritajatim.com)</strong> &ndash; Universitas Negeri Surabaya (Unesa) memiliki gedung baru, yakni Gedung Teknik Informatika. Peresmian dilakukan Wakil Gubernur Jatim, Emil Elestianto Dardak, Kamis (15/8/2019) petang.</p>\r\n\r\n<p>Peresmian gedung megah tersebut ditandai dengan pengguntingan pita yang dilakukan Emil didampingi Rektor Unesa, Prof Nurhasan. Sedangkan penandatanganan prasasti diteken berdua, dilanjut pemotongan tumpeng oleh Emil yang diberikan ke Prof Hasan.</p>\r\n\r\n<p>Hadir dalam acara peresmian sejumlah pejabat Pemprov Jatim, tokoh pendidikan, serta direksi BUMN dan BUMD, di antaranya Dirut PT Garam (Persero) Budi Sasongko.</p>\r\n\r\n<p>Sedangkan undangan yang tidak bisa hadir lantaran kesibukan, termasuk sejumlah anggota DPRD Jatim, memilih mengirimkan bunga tanda ucapan selamat yang terlihat mengular di depan gedung.</p>\r\n\r\n<p>Emil menuturkan, peresmian gedung ini sekaligus menandakan sebuah aset pembangunan sumber daya manusia (SDM) bertambah lagi di Surabaya dan Jatim.</p>\r\n\r\n<p>&ldquo;Gedung Teknik Informatika yang insyaallah jadi fakultas,&rdquo; kata Emil yang disambut aplaus panjang undangan. &ldquo;Insya Allah jadi fakultas,&rdquo; tandasnya.</p>\r\n\r\n<p>Dalam pidatonya, Emil juga menyoroti perkembangan yang serba cepat terkait informatika. Karena itu, mereka yang terjun di jurusan teknik informatika jangan terpaku pada text book, tapi harus ditunjang dengan rajin membaca. &ldquo;Bacanya pun bukan hanya buku aja, tapi juga baca majalah, nyari-nyari di internet, artikel,&rdquo; kata mantan bupati Trenggalek tersebut.</p>\r\n', '2019-12-19 09:51:15', 2, 'Teknologi', 0, '999a2060c08ee79cdd4234e7460faaa8.jpg', 1, 'Administrator', 0, 'resmikan-gedung-megah-teknik-informatika-unesa,-emil:-insya-allah-jadi-fakultas.html', 0);
